...
<p class="text-center mb-0">Phone no</p>
        ...
        <div class="info">
          ...
          <div class="information">
            ...
            <p class="text-center mb-0" style="color:black;">amit.mandaliya29@gmail.com</p>
          </div>
          <div class="information">
            <img src="attachments/phone.png" class="icon" alt="" />
            <p class="text-center mb-0" style="color:black;">+91 9822489703 </p>
          </div>
        </div>
